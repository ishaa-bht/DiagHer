...
class DrugAnalyzer:
    ...
    def calculate_risk_score(self, drug_name: str, age_group: str) -> Dict:
        ...
        # Filter data for the specific drug and age group
    ...
    def get_pregnancy_breastfeeding_risks(self, drug_name: str, age_group: str) -> Dict:
        ...
        # Get the most common risk levels
    ...
    def analyze_drug(self, drug_info: Dict) -> Dict:
        ...
        # Get pregnancy/breastfeeding risks
...
def health_check():
    ...
    return jsonify({
        ...
        'data_loaded': analyzer.drug_data is not None,
        'total_records': len(analyzer.drug_data) if analyzer.drug_data is not None else 0
    })

@app.route('/api/analyze-drug', methods=['POST'])
...
def analyze_medications():
    ...
    try:
        ...
        for med in medications:
            # Merge patient info with medication info
            med_info = {
                **med,
...
@app.route('/api/drug-alternatives', methods=['GET'])
...
def get_available_drugs():
    ...
    try:
        if analyzer.drug_data is None:
            return jsonify({'error': 'No drug data available'}), 500
